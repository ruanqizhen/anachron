...
const Ac: EthnicGroup[] = [
  ...
  { id: "karakhanid", name: "葱岭回鹘", alias: "Karakhanid", start: 840, end: 1212, x: 32, lane: "turkic", lang: "喀喇汗语", polities: ["喀喇汗朝 840-1212"], desc: "首个伊斯兰化突厥王朝" },
  ...
  { id: "laterTang", name: "中原沙陀", alias: "Later Tang", start: 923, end: 936, x: 66, lane: "turkic", lang: "突厥-汉", polities: ["后唐 923-936 李存勖"], desc: "沙陀建五代第一朝" },
  { id: "laterJin", name: "河东沙陀", alias: "Later Jin/Han", start: 936, end: 951, x: 68, lane: "turkic", lang: "突厥-汉", polities: ["后晋 936-947", "后汉 947-951"], desc: "石敬瑭割燕云十六州" },
  ...
  { id: "bohai", name: "渤海人", alias: "Bohai", start: 698, end: 926, x: 96, lane: "tungusic", lang: "靺鞨-汉", polities: ["渤海 698-926", "海东盛国"], desc: "粟末靺鞨+高句丽遗民", highlight: true },
